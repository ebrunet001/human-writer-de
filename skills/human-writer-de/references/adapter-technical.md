...
- **Lead with the WHY, not the WHAT.** State the problem this doc solves in the first sentence. "This README documents how we migrated from PPU to PPE billing in the Wine BI scraper."
...
- `tells-stylistic-de.md`: vocabulary tells, with the suspect-word lists
