...
Priority ranking, applied on top of the language adapter (`tells-stylistic-de.md`):
...
- `tells-stylistic-de.md`: language-specific vocabulary and construction tells
